...
//	public void testTags() throws Exception {
		...
		driver.findElement(By.xpath("//input[@class='enText']")).sendKeys("flash light");
		driver.findElement(By.xpath("//input[@class='arText']")).sendKeys("ضوء فلاش");
		
		driver.findElement(By.id("add_more_tag")).click();
		
		driver.findElement(By.xpath("//div[@id='tags_container']/div[2]/span/input[1]")).clear();
		driver.findElement(By.xpath("//div[@id='tags_container']/div[2]/span/input[1]")).sendKeys("red light");
		driver.findElement(By.xpath("//div[@id='tags_container']/div[2]/span/input[2]")).clear();
		driver.findElement(By.xpath("//div[@id='tags_container']/div[2]/span/input[2]")).sendKeys("النور الأحمر");
